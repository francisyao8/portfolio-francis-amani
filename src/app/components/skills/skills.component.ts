    ...
    <section class="skills" id="skills">
      <div class="container">
        <div class="section-header fade-in-up">
          ...
          <p>Des technologies modernes pour construire des solutions robustes et scalables.</p>
        </div>

        <div class="skills-grid">
          <div class="skill-group card fade-in-up" *ngFor="let group of skillGroups">
            ...
            <div class="skills-list">
              <div class="skill-item" *ngFor="let skill of group.skills">
                ...
                <p-progressBar [value]="skill.level" [showValue]="false"></p-progressBar>
              </div>
            </div>
          </div>
        </div>
...
export class SkillsComponent {
  ...
  techChips = [
    'Angular 16+', 'PrimeNG', 'Spring Boot', 'Laravel', 'Flutter',
    'Ionic', 'Docker', 'Git', 'Figma', 'PostgreSQL', 'MySQL',
    'REST API', 'JWT', 'SCSS', 'TypeScript', 'Python', 'Linux',
    'Canva', 'Agile/Scrum'
  ];
}
